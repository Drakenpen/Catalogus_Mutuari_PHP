<div class="jumbotron">
  <h1 class="display-3">Catalogus Mutuari versie 2.0</h1>
  <p class="lead">Welkom bij Catalogus Mutuari version 2.0.</p>
  ...
  <hr class="my-4">
  <p class="text-info">Voor het C# project, klik hier:</p>
  <p class="lead">
    <a class="btn btn-info btn-lg" href="" role="button">Catalogus Mutuari 1.0</a>
  </p>
</div>